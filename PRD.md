...
- [ ] Create a standardized format for task management in markdown <!-- PRD-100003 -->
...
- [ ] Syntax highlighting @frontend-team <!-- PRD-100015 -->
  ...
  - [ ] Highlight assignee mentions (@username-copilot) <!-- PRD-100017 -->
...
- [ ] Server implementation @ai-team <!-- PRD-100038 -->
  - [ ] WebSocket or stdio transport <!-- PRD-100039 -->
  - [ ] Authentication mechanism <!-- PRD-100040 -->
  - [ ] Rate limiting <!-- PRD-100041 -->
- [ ] Tool implementations @ai-team <!-- PRD-100042 -->
...
```markdown
- [ ] Task description @assignee <!-- PRD-XXXXXX -->
  - [ ] Subtask <!-- PRD-YYYYYY -->
- [x] Completed task @assignee <!-- PRD-ZZZZZZ -->
```
